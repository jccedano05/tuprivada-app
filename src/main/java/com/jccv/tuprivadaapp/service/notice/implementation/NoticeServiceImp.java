...
public class NoticeServiceImp implements NoticeService {
    ...
    @Autowired
    public NoticeServiceImp(OneSignalPushNotificationService oneSignalPushNotificationService,NoticeRepository noticeRepository, NoticeMapper noticeMapper, CondominiumRepository condominiumRepository, PollingNotificationService pollingNotificationService) {
    ...
    public NoticeDto createNotice(NoticeDto noticeDTO) {
        ...
        pollingNotificationService.createNotificationForCondominium(noticeDTO.getCondominiumId(), PollingNotificationDto.builder()
                        ...
                        .message(noticeDTO.getContent())
                        .read(false)
                .build());

        oneSignalPushNotificationService.sendPushToCondominium(notice.getCondominium().getId(), PushNotificationRequest.builder()
